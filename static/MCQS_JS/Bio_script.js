...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function selectAnswer(button, question) {
    ...
    userAnswers[currentQuestionIndex] = button.innerHTML; // Store user answer
    if (isCorrect) {
  ...
  function showAnswerKey() {
    resetState();
    questionElement.innerHTML = `You scored ${score} out of ${questions.length}! Here are the correct answers and explanations:`;
    nextButton.style.display = "none";
